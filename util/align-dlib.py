...
pred=os.path.join(dlibModelDir, "shape_predictor_68_face_landmarks.dat")
print pred
alignMain('./alignedImages/','E:\\Year 4\\openface - Copy\\training-images','outerEyesAndNose',pred,True,96,False)